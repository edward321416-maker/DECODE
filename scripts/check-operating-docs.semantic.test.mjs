...
const SEMANTIC_FILES = [
  ...
  "readiness/src/index.ts", "readiness/src/domain/contracts.ts", "readiness/src/domain/run-id.ts",
  "readiness/src/gates/gate-catalog-types.ts", "readiness/src/cli.ts",
  "readiness/src/persistence/run-artifact.ts",
];
