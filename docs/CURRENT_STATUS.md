...
- `docs/PUBLICATION_FILES.json` → version 4 (adds `CLAUDE.md`; 49 files). Replaces the stale "M0 publication inventory v2 is canonical" wording — the canonical inventory is now v4.
